...
```jsonl
{"id":"fetch-mcp-e2e","file":"knowledge/fetch-mcp-e2e.md","title":"fetch MCP e2e","tags":["finding","fetch-mcp"],"provenance":"tutus/master","context":"MINUTES:2026-03-21#fetch","refs_out":["CONSTITUTION#security"],"refs_in":["audit-2026-03"],"updated":"2026-03-21","status":"active"}
```
...
grep '"gh-oauth-fallback"' INDEX.jsonl    # read refs_out

# What references "gh-oauth-fallback"?
grep '"gh-oauth-fallback"' INDEX.jsonl    # read refs_in (or grep all refs_out)
```
