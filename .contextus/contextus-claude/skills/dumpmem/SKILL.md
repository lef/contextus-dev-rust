...
`.spec/MINUTES.md`（または `MINUTES.md`）にこのセッションの議題を記録する。
既に議題単位で書いてあれば追記不要。まだ書いていなければここでまとめて書く。

- 各議題: `### 議題N: [タグ] タイトル` + 議論要点 + 決定/実施
- 未完の議題は「継続中」と記録
- rules/minutes.md のフォーマットに従う
